...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static String ringToneValue;
    ...
    private void savePreferences() {
        ...
        if (findPreference(getString(R.string.pref_title_new_alert_notifications)).isEnabled()) {
            editor.putBoolean(NOTIFICATION_ENABLED, true);
        }
        else {
            editor.putBoolean(NOTIFICATION_ENABLED, false);
        }
        if (findPreference(getString(R.string.pref_title_vibrate)).isEnabled()) {
            editor.putBoolean(VIBRATE_MODE, true);
        }
        else {
            editor.putBoolean(VIBRATE_MODE, false);
        }
        editor.putString(RINGTONE, ringToneValue);
        editor.commit();
    }
            ...
            if (preference instanceof ListPreference) {
                ...
                if (TextUtils.isEmpty(stringValue)) {
                    ...
                    if (ringtone == null) {
                        ...
                        // name.
                        ringToneValue = ringtone.getTitle(preference.getContext());
                        preference.setSummary(ringToneValue);
                    }
                }
